...
import { adminAuthorRequestsRouter } from './routes/admin-author-requests.js';
import { adminRecentActivityRouter } from './routes/admin-recent-activity.js';
...
app.use('/api/admin', adminAuthorRequestsRouter);
